# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2016-04-27 18:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sku', models.UUIDField(primary_key=True, serialize=False)),
        ...
        migrations.AddField(
            ...
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='project1.Users'),
        ),
        migrations.AddField(
            model_name='order_shopping',
            name='oSku',
